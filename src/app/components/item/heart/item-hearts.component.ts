...
import { AgAreaLinkRendererComponent } from '@app/components/grid/renderers/ag-area-link-renderer/ag-area-link-renderer.component';
...
import { AgHeartsRendererComponent } from '@app/components/grid/renderers/ag-hearts-renderer/ag-hearts-renderer.component';
...
export class ItemHeartsComponent {
  ...
  readonly spiritColDefs: ColDef[] = [
    { headerName: 'Spirit', valueGetter: (p: any) => p.data.spirit, cellRenderer: AgSpiritLinkRendererComponent, flex: 1, minWidth: 120 },
    { headerName: 'Type', valueGetter: (p: any) => p.data.spirit?.type, cellRenderer: AgSpiritTypeRendererComponent, width: 80, sortable: false },
    { headerName: 'Area', valueGetter: (p: any) => p.data.area, cellRenderer: AgAreaLinkRendererComponent, width: 180 },
    { headerName: 'Hearts', valueGetter: (p: any) => p.data, cellRenderer: AgHeartsRendererComponent, flex: 2, minWidth: 100, autoHeight: true, sortable: false },
  ];

  readonly eventColDefs: ColDef[] = [
    { headerName: 'Event', valueGetter: (p: any) => p.data.instance, cellRenderer: AgEventLinkRendererComponent, flex: 1, minWidth: 120 },
    { headerName: 'Hearts', valueGetter: (p: any) => p.data, cellRenderer: AgHeartsRendererComponent, flex: 2, minWidth: 100, autoHeight: true, sortable: false },
  ];
