...
import { readFingerprint } from '@app/components/outfit-request/closet-fingerprint';
...
@Component({
  ...
  styleUrl: './outfit-vault.component.scss',
  standalone: true,
...
export class OutfitVaultComponent implements OnInit {
  @ViewChild(VaultItemPickerComponent) private _picker?: VaultItemPickerComponent;
