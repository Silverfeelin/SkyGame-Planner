...
import { AtmosItemFiltersComponent } from '../filters/atmos-item-filters.component';
...
@Component({
  ...
  imports: [NgTemplateOutlet, LowerCasePipe, MatIcon, ItemTypePipe, AtmosItemTypeNavComponent, AtmosItemFiltersComponent]
})
