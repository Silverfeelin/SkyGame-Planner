...
@Component({
  selector: 'app-atmos-settings',
  templateUrl: './atmos-settings.component.html',
  styleUrl: './atmos-settings.component.scss',
  changeDetection: ChangeDetectionStrategy.OnPush,
  imports: [MatIcon, RouterLink, LowerCasePipe, DateTimePipe]
})
export class AtmosSettingsComponent implements OnDestroy {
